...
[CreateAssetMenu(fileName = "Burserk", menuName = "Data/Skill/Burserk", order = 1)]
public class Skill_Burserk_DataSCO : SkillData
{
    public override void SkillEnter(PlayerController player, EnemyController enemyController, Node node)
    {
        ...
        player.animator.SetInteger("TransitionIndex", (int)SKillID.Burserk);
    }
