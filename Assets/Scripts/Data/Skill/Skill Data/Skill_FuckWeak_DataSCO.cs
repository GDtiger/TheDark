...
[CreateAssetMenu(fileName = "FuckWeak", menuName = "Data/Skill/FuckWeak", order = 1)]
public class Skill_FuckWeak_DataSCO : SkillData
{
    public override void SkillEnter(PlayerController player, EnemyController enemyController, Node node)
    {
        ...
        player.animator.SetInteger("TransitionIndex", (int)SKillID.Fuck_Weak);
    }
